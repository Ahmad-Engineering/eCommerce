    ...
    <li class="nav-item has-sub sidebar-group-active" style=""><a class="d-flex align-items-center" href="#"><svg
        ...
        <ul class="menu-content">
            ...
            {{-- <li><a class="d-flex align-items-center" href="app-user-view.html"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle">
                        <circle cx="12" cy="12" r="10"></circle>
                    </svg><span class="menu-item text-truncate" data-i18n="View">View</span></a>
            </li> --}}
        </ul>
    </li>
@endsection
