...
<head>
    ...
    <title>Error - Manarat - Bootstrap HTML admin template</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('ecommerce/app-assets/css/pages/page-misc.css') }}">
    <!-- END: Page CSS-->
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <p class="mb-2">Oops! 😖 The requested URL was not found on this server.</p><a
                                class="btn btn-primary mb-2 btn-sm-block" href="{{route('home')}}">Back to home</a><img
                                class="img-fluid" src="{{ asset('ecommerce/app-assets/images/pages/error.svg') }}"
                                alt="Error page" />
                        </div>
                    </div>
                </div>
