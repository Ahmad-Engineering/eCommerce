...
<head>
    ...
    {{-- // $guard = ucfirst($guard); --}}
    <title>{{ ucfirst($guard) . ' Login' }}</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('ecommerce/app-assets/css/pages/page-auth.css') }}">
    <!-- END: Page CSS-->
    ...
    <!-- Toastr -->
    <link rel="stylesheet" href="{{ asset('ecommerce/plugins/toastr/toastr.min.css') }}">
</head>
<!-- END: Head-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click"
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="#">
                            ...
                            <h2 class="brand-text text-primary ms-1">Manarat</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid"
                                    src="{{ asset('ecommerce/app-assets/images/pages/login-v2.svg') }}"
                                    alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Welcome to Manarat! 👋</h2>
                                <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>
                                <form class="auth-login-form mt-2" action="index.html" method="POST">
                                    <div class="mb-1">
                                        <label class="form-label" for="email">Email</label>
                                        <input class="form-control" id="email" type="email" name="login-email"
                                    ...
                                    <button class="btn btn-primary w-100" tabindex="4" type="button"
                                        onclick="login('{{$guard}}')">Sign in</button>
                                </form>
    ...
    <script src="{{ asset('ecommerce/app-assets/vendors/js/forms/validation/jquery.validate.min.js') }}"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('ecommerce/app-assets/js/scripts/pages/page-auth-login.js') }}"></script>
    <!-- END: Page JS-->
